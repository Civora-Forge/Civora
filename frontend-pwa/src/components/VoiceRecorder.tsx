    ...
    <div className="flex flex-col items-center bg-teal-50 rounded-xl p-6 border border-teal-100">
      {!audioUrl && !isRecording && (
        <div className="text-center">
          <p className="text-teal-800 font-medium mb-4">Tap to speak in your language</p>
          <button
            type="button"
            onClick={onStart}
      ...
      {isRecording && (
        <div className="text-center w-full">
          ...
          <div className="text-3xl font-mono text-teal-900 mb-6">{formatTime(recordingDuration)}</div>
          <button
            type="button"
            onClick={onStop}
