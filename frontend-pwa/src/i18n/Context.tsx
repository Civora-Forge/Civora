...
type LanguageCode = 'en' | 'hi' | 'ml' | 'te' | 'ta';
...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'home.subtitle': 'Speak, type, or share a photo. We’ll help turn your concern into a clear development need.',
  ...
  hi: {
    ...
    'home.subtitle': 'बोलें, टाइप करें या फ़ोटो साझा करें। हम आपकी चिंता को स्पष्ट विकास आवश्यकता में बदलने में मदद करेंगे।',
  ...
  ml: {
    ...
    'home.subtitle': 'സംസാരിക്കുക, ടൈപ്പ് ചെയ്യുക, അല്ലെങ്കിൽ ഒരു ഫോട്ടോ പങ്കിടുക.',
  ...
  ta: {
    ...
    'home.subtitle': 'பேசவும், தட்டச்சு செய்யவும் அல்லது புகைப்படத்தைப் பகிரவும்.',
...
export const I18nProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => {
    const stored = localStorage.getItem('civora_lang') as LanguageCode;
