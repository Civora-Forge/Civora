...
export const IssueDetail = () => {
  ...
  const issue = {
    ...
    summary:
      "Residents are requesting repairs to the damaged road leading to the Government School because poor road conditions are affecting daily travel and student access.",
    ...
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="p-5 space-y-6">
        <div className="bg-blue-50 text-blue-800 p-3 rounded-lg text-sm border border-blue-100">
          Note: This is demo data. Backend does not yet provide a GET
          /issues/:id endpoint.
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
          <div className="flex justify-between items-start mb-3">
            ...
            <div className="flex gap-2">
              {issue.hasVoice && (
                <span className="text-xl" title="Voice submitted">
                  🎤
                </span>
              )}
              {issue.hasPhoto && (
                <span className="text-xl" title="Photo submitted">
                  📷
                </span>
              )}
            </div>
          ...
          <div className="flex flex-col gap-2 text-sm text-gray-600 mb-6">
            ...
            <div className="flex items-center">
              ...
              <span>
                {new Date(issue.date).toLocaleDateString()} at{" "}
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-2xl p-5 flex items-center justify-between shadow-sm">
          <div>
            <div className="text-teal-900 font-bold text-lg">
              {issue.similarCount} similar needs
            </div>
