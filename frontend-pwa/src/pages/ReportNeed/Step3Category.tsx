...
import { Bus, Droplet, Activity, BookOpen, Trash2, ShieldAlert, GripHorizontal, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const Step3Category = () => {
  ...
  const handleSelect = (id: ReportCategory) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="bg-white px-5 py-4 border-b border-gray-200 sticky top-0 z-10 shadow-sm flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900">{t('report.step3.title')}</h1>
      </div>

      <div className="flex-1 p-5 pb-32">
        <p className="text-gray-600 mb-6">Select a category that best describes the need.</p>
