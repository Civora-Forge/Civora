  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="bg-white px-5 py-4 border-b border-gray-200 sticky top-0 z-10 shadow-sm flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900">{t('report.step2.title')}</h1>
      </div>
      ...
      <div className="flex-1 p-5 space-y-6">
        ...
        <div>
          <h2 className="text-sm font-bold text-gray-700 mb-3">Enter location manually</h2>
          <input
            type="text"
          ...
          />
          <p className="text-xs text-gray-500 mt-2 ml-1">If you don't know the exact coordinates, you can just describe the area.</p>
        </div>
      </div>
